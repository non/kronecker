...
object CTupleBooleanBoolean extends CountableTests[(Boolean, Boolean)]
object CTupleLongIntShortByte extends CountableTests[(Long, Int, Short, Byte)]
object CHListBBBB extends CountableTests[Byte :: Byte :: Byte :: Byte :: HNil]
...
object CTupleZZZ extends CountableTests[(Z, Z, Z)]
object CTupleZByteByte extends CountableTests[(Z, Byte, Byte)]
